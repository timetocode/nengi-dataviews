...
test('constructs from buffer', () => {
    ...
    const br = new DataViewWriter_1.DataViewWriter(buf, 0);
...
test('constructs from buffer at an offset', () => {
    ...
    const bw = new DataViewWriter_1.DataViewWriter(buf, 1);
...
test('writeUInt8', () => {
    ...
    const buf = new ArrayBuffer(1);
    const view = new DataView(buf);
    const bw = new DataViewWriter_1.DataViewWriter(buf, 0);
    bw.writeUInt8(value);
